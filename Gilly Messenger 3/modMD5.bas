...
Private Function BytesToLong(TheArray() As Byte) As Long
...
Private Sub LongToBytes(ByRef TheArray() As Byte, ByRef TheLong As Long)
...
Public Function MD5Encrypt(strPassword As String) As String
    Dim bytBuffer() As Byte
